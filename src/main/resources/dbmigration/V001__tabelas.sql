...
ALTER TABLE oportunidade_habilidade
    ADD CONSTRAINT FKisutn448yo9f64n7m2ous7bgb
    FOREIGN KEY (id_habilidade) REFERENCES habilidade;

ALTER TABLE oportunidade_habilidade
    ADD CONSTRAINT FKacrlkraktctermq591lmu94ap
    FOREIGN KEY (id_oportunidade) REFERENCES oportunidade;

ALTER TABLE perfil_habilidade
    ADD CONSTRAINT FK7cixglis4e212gwomc5yyklwo
    FOREIGN KEY (id_habilidade) REFERENCES habilidade;

ALTER TABLE perfil_habilidade
    ADD CONSTRAINT FKpgqfijhop7qrmsjequx693rpu
    FOREIGN KEY (id_perfil) REFERENCES perfil;
